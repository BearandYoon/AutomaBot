...
@Component({
  ...
  template: `
            <div *ngIf="props" style="margin: 0 auto;" [style.background-color]="props.background" [style.width] = "props.size" [style.line-height]='props.lineheight' [style.height] = 'props.size' [style.font-size] = 'props.fontSize' [style.border] = 'props.border' [style.border-radius] = 'props.borderradius' [style.text-align] ="props.textalign"> 
...
export class LetterAvatarDirective implements OnInit, OnChanges {
  ...
  generateLetter() {
    ...
    var size = this.avatarData && this.avatarData.size ? this.avatarData.size : 35;
